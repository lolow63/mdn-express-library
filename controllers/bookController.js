...
exports.book_list = asyncHandler(async (req, res, next) => {
    const allBooks = await Book.find({}, 'title author').sort({ title: 'ascending' }).populate('author').exec();
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
    ...
    if (allInstancesByBook.length > 0) {
        ...
        // Books has no instances. Delete object and redirect to the list of books.
